 ...
 */
public class Cwfgm_Fuel_C2 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type C2
	 */
	public Cwfgm_Fuel_C2() {
		m_name = "C-2 Boreal Spruce";
		m_fuel.m_defaultFuelType = this.getClass();
		
		m_fuel.m_spread = new SpreadParms_C1();
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_C2_DEFAULTS, 0.0);
		...
		m_fuel.m_SFCCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.SFC_C2_DEFAULTS, 0.0);
		...
		m_fuel.m_DBHCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.HUANG_DBH_C2_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_C2 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_C2)super.clone();
	}
}
