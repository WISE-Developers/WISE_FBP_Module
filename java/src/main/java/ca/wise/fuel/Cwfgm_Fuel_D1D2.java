...
/**
 * Implements the FBP D1/D2 fuel type.
 */
public class Cwfgm_Fuel_D1D2 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type D1/D2
	 */
	public Cwfgm_Fuel_D1D2() {
		m_name = "D-1/D-2 Aspen";
		m_fuel.m_defaultFuelType = this.getClass();
		
		m_fuel.m_spread = new SpreadParms_D1();
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_D1_DEFAULTS, 0.0);
		...
		m_fuel.m_SFCCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.SFC_D1_DEFAULTS, 0.0);
		m_fuel.m_SFCCalculation_Greenup = new SFC_D2();
		m_fuel.m_SFCCalculation_Greenup.setAttributeValue((short)FUELCOM_ATTRIBUTE.SFC_D2_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_D1D2 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_D1D2)super.clone();
	}
}
