...
/**
 * Implements the FBP M1 fuel type.
 */
public class Cwfgm_Fuel_M1 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type M1
	 */
	public Cwfgm_Fuel_M1() {
...
//		((RSI_M1)m_fuel.m_RSICalculation).m_p1 = 1.0;
		...
		m_fuel.m_CFBCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.CFB_M1_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_M1 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_M1)super.clone();
	}
}
