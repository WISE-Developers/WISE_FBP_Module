...
/**
 * Implements the FBP O1b fuel type.
 */
public class Cwfgm_Fuel_O1b extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type O1b
	 */
	public Cwfgm_Fuel_O1b() {
		m_name = "O-1b Standing Grass";
		m_fuel.m_defaultFuelType = this.getClass();
		
		m_fuel.m_spread = new SpreadParms_O1();
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_O1B_DEFAULTS, 0.0);
		...
		m_fuel.m_SFCCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.SFC_O1B_DEFAULTS, 0.0);
		...
		m_fuel.m_CFBCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.CFB_O1B_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_O1b clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_O1b)super.clone();
	}
}
