...
/**
 * Implements the FBP D1 fuel type.
 */
public class Cwfgm_Fuel_D1 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type D1
	 */
	public Cwfgm_Fuel_D1() {
	 ...
	 */
	@Override
	public Cwfgm_Fuel_D1 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_D1)super.clone();
	}
}
