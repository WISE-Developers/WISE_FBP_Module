...
/**
 * Implements the FBP C6 fuel type.
 */
public class Cwfgm_Fuel_C6 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type C6
	 */
	public Cwfgm_Fuel_C6() {
		m_name = "C-6 Conifer Plantation";
		m_fuel.m_defaultFuelType = this.getClass();
		
		m_fuel.m_spread = new SpreadParms_C6();
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_C6_DEFAULTS, 0.0);
		...
		m_fuel.m_SFCCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.SFC_C6_DEFAULTS, 0.0);
		...
		m_fuel.m_DBHCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.HUANG_DBH_C6_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_C6 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_C6)super.clone();
	}
}
