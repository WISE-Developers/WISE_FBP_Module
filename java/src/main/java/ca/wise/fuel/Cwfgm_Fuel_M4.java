...
/**
 * Implements the FBP M4 fuel type.
 */
public class Cwfgm_Fuel_M4 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type M4
	 */
	public Cwfgm_Fuel_M4() {
		...
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_M4_DEFAULTS, 0.0);
		...
		m_fuel.m_SFCCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.SFC_M4_DEFAULTS, 0.0);
		...
		m_fuel.m_ISFCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.RSI_M4_DEFAULTS, 0.0);
		...
		m_fuel.m_CFBCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.CFB_M4_DEFAULTS, 0.0);
		m_fuel.m_DBHCalculation = new DBH_1();
		m_fuel.m_DBHCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.HUANG_DBH_M4_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_M4 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_M4)super.clone();
	}
}
