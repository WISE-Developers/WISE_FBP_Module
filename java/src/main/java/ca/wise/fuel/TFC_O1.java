...
public class TFC_O1 extends TFCAttribute {
	...
	public short getExternalDefinition() { 
		return FUELCOM_EQUATION.SELECTION_TFC_O1;
	};
	...
	public boolean equals(Object other) {
		if (other == null)
			return false;
		return (other instanceof TFC_O1);
	}
	...
	public ca.wise.fuel.proto.TfcAttribute serialize(SerializeProtoOptions options) {
		...
		TfcO1.Builder msgRet = TfcO1.newBuilder();
		msgRet.setVersion((int)serialVersionUID);

		TfcO1.Parms.Builder msg = TfcO1.Parms.newBuilder();
	...
	@Override
	public TFC_O1 deserialize(Message proto) {
		TfcO1 msgRead;
		...
		if(msgRead.hasParms()) {
			TfcO1.Parms msg = msgRead.getParms();
