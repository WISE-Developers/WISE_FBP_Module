...
/**
 * Implements the FBP S3 fuel type.
 */
public class Cwfgm_Fuel_S3 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type S3
	 */
	public Cwfgm_Fuel_S3() {
		...
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_S3_DEFAULTS, 0.0);
		...
		m_fuel.m_SFCCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.SFC_S3_DEFAULTS, 0.0);
		...
		m_fuel.m_CFBCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.CFB_S3_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_S3 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_S3)super.clone();
	}
}
