...
/**
 * Implements the FBP C5 fuel type.
 */
public class Cwfgm_Fuel_C5 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type C5
	 */
	public Cwfgm_Fuel_C5() {
		m_name = "C-5 Red and White Pine";
		m_fuel.m_defaultFuelType = this.getClass();
		
		m_fuel.m_spread = new SpreadParms_C1();
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_C5_DEFAULTS, 0.0);
		...
		m_fuel.m_SFCCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.SFC_C5_DEFAULTS, 0.0);
		...
		m_fuel.m_DBHCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.HUANG_DBH_C5_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_C5 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_C5)super.clone();
	}
}
