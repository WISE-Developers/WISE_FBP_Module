...
/**
 * Implements the FBP O1a fuel type.
 */
public class Cwfgm_Fuel_O1a extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type O1a
	 */
	public Cwfgm_Fuel_O1a() {
		m_name = "O-1a Matted Grass";
		m_fuel.m_defaultFuelType = this.getClass();
		
		m_fuel.m_spread = new SpreadParms_O1();
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_O1A_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_O1a clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_O1a)super.clone();
	}
}
