 ...
 */
public class Cwfgm_Fuel_C3 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type C3
	 */
	public Cwfgm_Fuel_C3() {
		m_name = "C-3 Mature Jack or Lodgepole Pine";
		m_fuel.m_defaultFuelType = this.getClass();
		
		m_fuel.m_spread = new SpreadParms_C1();
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_C3_DEFAULTS, 0.0);
		...
		m_fuel.m_SFCCalculation.setAttributeValue(
				(short)FUELCOM_ATTRIBUTE.SFC_C3_DEFAULTS, 0.0);
		...
		m_fuel.m_DBHCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.HUANG_DBH_C3_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_C3 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_C3) super.clone();
	}
}
