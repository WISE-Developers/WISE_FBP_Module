...
/**
 * Implements the FBP S2 fuel type.
 */
public class Cwfgm_Fuel_S2 extends Cwfgm_Fuel_Readonly {
	/**
	 * Creates and initializes a read-only fueltype of type S2
	 */
	public Cwfgm_Fuel_S2() {
		m_name = "S-2 White Spruce / Balsam Slash";
		m_fuel.m_defaultFuelType = this.getClass();
		
		m_fuel.m_spread = new SpreadParms_S1();
		m_fuel.m_spread.setAttributeValue((short)FUELCOM_ATTRIBUTE.SPREADPARMS_S2_DEFAULTS, 0.0);
		...
		m_fuel.m_SFCCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.SFC_S2_DEFAULTS, 0.0);
		...
		m_fuel.m_CFBCalculation.setAttributeValue((short)FUELCOM_ATTRIBUTE.CFB_S2_DEFAULTS, 0.0);
	 ...
	 */
	@Override
	public Cwfgm_Fuel_S2 clone() throws CloneNotSupportedException {
		return (Cwfgm_Fuel_S2)super.clone();
	}
}
